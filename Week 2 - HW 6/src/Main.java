...
public class Main {
    ...
    static void playerMove() throws InputMismatchException, Exception {
        ...
        if (isValidMove(move)){
            ...
            throw new Exception("Invalid move please make a move from (1-9) and not in an already played spot.");
    }
